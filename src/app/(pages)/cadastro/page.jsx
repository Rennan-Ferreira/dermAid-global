    ...
    <div className={styles.outerContainer}>
      <div className={styles.innerContainer}>
        <div className={styles.leftSide}>
          <h2 className={styles.title}>Faça seu <span className={styles.cadastroText}>CADASTRO</span>. Já possui conta? Faça seu Login ou <span className={styles.signupText}>Cadastre-se</span></h2>
